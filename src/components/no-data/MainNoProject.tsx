const MainNoProject = () => {
  return (
    <div className="flex flex-col items-center justify-center rounded-2xl border border-dashed border-neutral-800 bg-neutral-900/30 px-6 py-20 text-center">
      ...
      <p className="font-mono text-xs text-neutral-500 mb-2">{`// Warning: No entries found in projects.log`}</p>
      <h3 className="font-serif text-lg text-neutral-400 break-keep">아직 기록된 프로젝트가 없습니다.</h3>

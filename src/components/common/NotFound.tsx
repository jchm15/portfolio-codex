  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-neutral-950 px-6 text-neutral-50">
      <div className="max-w-lg text-center">
        <p className="mb-3 text-xs font-medium tracking-[0.3em] text-[#C9A66B] uppercase">cat error.log</p>

        <div className="font-serif text-8xl font-black tracking-tight text-neutral-100">404</div>

        <h1 className="mt-6 font-serif text-3xl tracking-tight text-balance">페이지를 찾을 수 없습니다</h1>

        <p className="mt-4 text-sm text-neutral-500">요청하신 경로가 존재하지 않거나 이동되었습니다.</p>
